...
class Users extends Model
{
    ...
    public static function insert_new_user_csv($item,$user_create)
    {
        ...
        $user = Users::create_user($item->emp_code, $item->name_th, $item->name_en, $item->postname_th, $item->postname_en, $item->email, $item->status, $item->group_id, $item->type, $item->username, $password, $user_create);
        $sql = "
        SELECT * FROM users WHERE
        emp_code = '{$item->emp_code}'
        AND type = {$item->type}
